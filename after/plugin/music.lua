local client_id = vim.env.RSPOTIFY_CLIENT_ID -- or vim.fn.system "pass spotify.nvim/client-id"
local client_secret = vim.env.RSPOTIFY_CLIENT_SECRET -- or vim.fn.system "pass spotify.nvim/client-secret"
