...
vim.api.nvim_set_keymap("",  "Q",         ":echo<CR>",             noremap)
...
vim.api.nvim_set_keymap(n, "<c-k>", ":m .-2<CR>==", noremap)
...
vim.api.nvim_set_keymap(
	n, "<space>ne", ":set noexpandtab!<cr>", noremap
)

vim.api.nvim_set_keymap(
	n, "<space>et", ":set expandtab!<cr>", noremap
)
