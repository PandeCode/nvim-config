...
return require("packer").startup(
		...
		use {
			...
			config = function() require("config.lualineNvim") end
		}
		use {
		...
		use {
			...
			config = function() require("config.godot") end
		}
		...
		use {
			"Konfekt/vim-office",
			ft = {"docx", "pdf", "doc"},
			config = function() require("config.office") end
		}
		...
		use {
			...
			config = function() require("config.mundo") end
		}
		...
		use {
			"kkoomen/vim-doge",
			config = function() require("config.doge") end,
			ft = {
				"cpp",
				"c",
				"java",
