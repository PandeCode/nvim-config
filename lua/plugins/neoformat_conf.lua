...
vim.api.nvim_set_keymap(Keys.N, "<Space>cf", ":Neoformat<CR>", Keys.NoremapSilent)
vim.api.nvim_set_keymap(Keys.V, "<Space>cf", ":Neoformat<CR>", Keys.NoremapSilent)

vim.api.nvim_set_keymap(Keys.N, "<Space>nf", ":Neoformat<CR>", Keys.NoremapSilent)
vim.api.nvim_set_keymap(Keys.V, "<Space>nf", ":Neoformat<CR>", Keys.NoremapSilent)
